import { scheduleHero } from "@/data/mock-schedule-call";

export function ScheduleHero() {
  return (
    <section className="relative flex flex-col items-center pt-24 pb-16 px-10 overflow-clip bg-white">
      {/* Decorative glows */}
      <div
      ...
      {/* Subtext */}
      <p className="relative text-[18px] leading-[165%] max-w-[540px] text-center text-[#64748B] font-sans">
        {scheduleHero.subtext}
      </p>
    </section>
  );
}
