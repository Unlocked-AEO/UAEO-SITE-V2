          ...
          return (
            ...
            >
              <svg width="76" height="76" viewBox="0 0 76 76" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: '0' }}>
                ...
                <text x="38" y="38" textAnchor="middle" dominantBaseline="central" fontFamily="Manrope" fontSize="18" fontWeight="800" fill="#0A2540">
                  {gauge.score}
                </text>
              </svg>
              <div className="mt-1.5 inline-block text-[#425466] font-sans font-semibold text-[11px]/3.5">
                {gauge.label}
              </div>
            </div>
          );
